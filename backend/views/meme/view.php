...
<div class="giiant-crud meme-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . Yii::t('app', 'List Memes'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    ...
    <?php $this->beginBlock('common\models\Meme'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            ...
            ['meme-vidmage/create', 'MemeVidmage' => ['meme_id' => $model->id]],
    ...
    'content' => $this->blocks['common\models\Meme'],
    'active'  => true,
],[
