...
?>
<div class="giiant-crud author-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . Yii::t('app', 'List Authors'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    ...
    <?php $this->beginBlock('common\models\Author'); ?>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            ...
            ['vidmage-author/create', 'VidmageAuthor' => ['author_id' => $model->id]],
    ...
    'content' => $this->blocks['common\models\Author'],
    'active'  => true,
],[
