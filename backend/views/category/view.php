...
<div class="giiant-crud category-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . Yii::t('app', 'List Categories'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            ...
            ['vidmage-category/create', 'VidmageCategory' => ['category_id' => $model->id]],
